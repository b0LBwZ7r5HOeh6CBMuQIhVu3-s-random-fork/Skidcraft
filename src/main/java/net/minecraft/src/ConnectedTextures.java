...
public class ConnectedTextures
{
    ...
    public static ConnectedProperties getConnectedProperties(IBlockAccess var0, Block var1, int var2, int var3, int var4, int var5, Icon var6)
    {
        ...
        else
        {
            ...
            {
                int var13 = var1.blockID;

                if (var13 >= 0 && var13 < blockProperties.length)
                {
                    ConnectedProperties[] var14 = blockProperties[var13];
                    ...
                    if (var14 != null)
                    {
                        ...
                        ConnectedProperties var12 = getConnectedProperties(var14, var0, var1, var2, var3, var4, var5, var7, var9);
    ...
    private static Icon getConnectedTexture(ConnectedProperties var0, IBlockAccess var1, Block var2, int var3, int var4, int var5, int var6, Icon var7, int var8)
    {
        if (var4 >= var0.minHeight && var4 <= var0.maxHeight)
        {
            ...
            {
                int[] var16 = var0.metadatas;
                boolean var17 = false;

                for (int var13 = 0; var13 < var16.length; ++var13)
                {
                    if (var16[var13] == var15)
                    {
                        var17 = true;
                        break;
                    }
