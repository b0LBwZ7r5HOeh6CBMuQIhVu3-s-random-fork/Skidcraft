...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void loadRenderers()
    {
        if (this.theWorld != null)
        {
            ...
            for (var7 = 0; var7 < this.renderChunksWide; ++var7)
            {
                for (int var11 = 0; var11 < this.renderChunksTall; ++var11)
                {
                    for (int var9 = 0; var9 < this.renderChunksDeep; ++var9)
                    {
                        ...
                        this.worldRenderers[var10] = WrUpdates.makeWorldRenderer(this.theWorld, this.tileEntities, var7 * 16, var11 * 16, var9 * 16, this.glRenderListBase + var4);
            ...
            if (this.theWorld != null)
            {
                ...
                if (var12 != null)
                {
                    this.markRenderersForNewPosition(MathHelper.floor_double(((EntityLiving)var12).posX), MathHelper.floor_double(((EntityLiving)var12).posY), MathHelper.floor_double(((EntityLiving)var12).posZ));
    ...
    public int sortAndRender(EntityLiving par1EntityLiving, int par2, double par3)
    {
        ...
        if (this.occlusionEnabled && this.mc.gameSettings.advancedOpengl && !this.mc.gameSettings.anaglyph && par2 == 0)
        {
            byte var22 = 0;
            byte var44 = 20;
            this.checkOcclusionQueryResult(var22, var44, par1EntityLiving.posX, par1EntityLiving.posY, par1EntityLiving.posZ);
            int var24;
        ...
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        int var29 = Integer.parseInt(par1Str.substring(par1Str.indexOf("_") + 1));
                        var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Item.itemsList[var29], this.renderEngine);
                    }
