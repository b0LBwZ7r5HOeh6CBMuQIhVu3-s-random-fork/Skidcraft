...
public class RenderBlocks
{
    ...
    public boolean renderBlockRedstoneWire(Block par1Block, int par2, int par3, int par4)
    {
        ...
        boolean var31 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, par2 + 1, par3, par4, 3) || !this.blockAccess.isBlockNormalCube(par2 + 1, par3, par4) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, par2 + 1, par3 - 1, par4, -1);
        boolean var32 = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, par2, par3, par4 - 1, 2) || !this.blockAccess.isBlockNormalCube(par2, par3, par4 - 1) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, par2, par3 - 1, par4 - 1, -1);
    ...
    public boolean renderBlockPane(BlockPane par1BlockPane, int par2, int par3, int par4)
    {
        ...
        double var110 = (double)var104.getMinV();
        double var111 = (double)var104.getMaxV();
        ...
        if ((!var100 || !var101) && (var100 || var101 || var98 || var99))
        {
            if (var100 && !var101)
            {
                var6.addVertexWithUV(var78, (double)(par3 + 1), var86, var107, var110);
                var6.addVertexWithUV(var78, (double)(par3 + 0), var86, var107, var111);
                var6.addVertexWithUV(var80, (double)(par3 + 0), var86, var108, var111);
                var6.addVertexWithUV(var80, (double)(par3 + 1), var86, var108, var110);
            ...
            else if (!var100 && var101)
            {
                var6.addVertexWithUV(var80, (double)(par3 + 1), var86, var108, var110);
                var6.addVertexWithUV(var80, (double)(par3 + 0), var86, var108, var111);
                var6.addVertexWithUV(var82, (double)(par3 + 0), var86, var109, var111);
                var6.addVertexWithUV(var82, (double)(par3 + 1), var86, var109, var110);
    ...
    public boolean renderBlockFluids(Block par1Block, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            if (this.renderAllFaces || var11)
            {
                var5.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3 - 1, par4));
                float var56 = 1.0F;
                var5.setColorOpaque_F(var14 * var56 * var7, var14 * var56 * var8, var14 * var56 * var9);
            ...
            for (int var58 = 0; var58 < 4; ++var58)
            {
                ...
                Icon var39 = this.getBlockIconFromSideAndMetadata(par1Block, var58 + 2, var23);
                ...
                if (this.renderAllFaces || var12[var58])
                {
                    ...
                    var5.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, var57, par3, var59));
                    float var55 = 1.0F;
