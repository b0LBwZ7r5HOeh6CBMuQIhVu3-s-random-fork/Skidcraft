...
public class TextureMap implements IconRegister
{
    ...
    public void refreshTextures()
    {
        ...
        while (var28.hasNext())
        {
            var30 = (List)var28.next();

            if (!var30.isEmpty())
            {
                this.scaleTextures(var30, this.iconGridSize);
            }
        }
        ...
        while (var28.hasNext())
        {
            ...
            if (!var30.isEmpty())
            {
                StitchHolder var33 = new StitchHolder((Texture)var30.get(0));
                var5.addStitchHolder(var33);
                var27.put(var33, var30);
            }
        }
        ...
        while (var8.hasNext())
        {
            StitchSlot var29 = (StitchSlot)var8.next();
            StitchHolder var32 = var29.getStitchHolder();
            Texture var35 = var32.func_98150_a();
            String var13 = var35.getTextureName();
            List var14 = (List)var27.get(var32);
            ...
            var15.init(this.atlasTexture, var14, var29.getOriginX(), var29.getOriginY(), var32.func_98150_a().getWidth(), var32.func_98150_a().getHeight(), var32.isRotated());
        ...
        while (var8.hasNext())
        {
            TextureStitched var31 = (TextureStitched)var8.next();
            var31.copyFrom(this.missingTextureStiched);
        }
        ...
        if (Config.isMultiTexture())
        {
            ...
            while (var28.hasNext())
            {
                TextureStitched var34 = (TextureStitched)var28.next();
                var34.createTileTexture();
            }
        }
    }
