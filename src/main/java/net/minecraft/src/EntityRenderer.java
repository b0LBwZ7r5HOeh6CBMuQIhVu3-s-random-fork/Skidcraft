...
public class EntityRenderer
{
    ...
    public void updateCameraAndRender(float par1)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            int var19 = var17 - Mouse.getY() * var17 / this.mc.displayHeight - 1;
            int var20 = performanceToFps(this.mc.gameSettings.limitFramerate);
            ...
            if (this.mc.theWorld != null)
            {
                ...
                {
                    this.renderWorld(par1, this.renderEndNanoTime + (long)(1000000000 / var20));
                }
                ...
                {
                    this.mc.ingameGUI.renderGameOverlay(par1, this.mc.currentScreen != null, var18, var19);
                }
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    this.mc.currentScreen.drawScreen(var18, var19, par1);
                }
                catch (Throwable var13)
                {
                    ...
                    var12.addCrashSectionCallable("Mouse location", new CallableMouseLocation(this, var18, var19));
