...
public abstract class EntityLiving extends Entity
{
    ...
    public boolean isOnLadder()
    {
        ...
        return Reflector.ForgeHooks_isLivingOnLadder.exists() ? Reflector.callBoolean(Reflector.ForgeHooks_isLivingOnLadder, new Object[] {Block.blocksList[var4], this.worldObj, Integer.valueOf(var1), Integer.valueOf(var2), Integer.valueOf(var3), this}): var4 == Block.ladder.blockID || var4 == Block.vine.blockID;
    }
    ...
    public void swingItem()
    {
        ...
        if (var1 != null && var1.getItem() != null)
        {
            ...
            if (Reflector.callBoolean(var2, Reflector.ForgeItem_onEntitySwing, new Object[] {this, var1}))
            {
                return;
            }
        }
